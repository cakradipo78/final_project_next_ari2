...
export async function GET (request) {
    ...
    let resultSearch = dataEvent.filter(el =>  el.title.toLowerCase().includes (searchTerm.toLowerCase()))
    console.log(resultSearch, "===> APA SIH HAHA");
    //console.log(searchTerm, "===> APA SIH....");
    return new Response(
        JSON.stringify({status :"success", data: resultSearch }),
     ...
     return new Response(
    JSON.stringify({ status: "success", data: error }),
